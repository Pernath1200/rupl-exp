...
| 32 | `a1_prep_do_z` | `prep_do_gen`, `prep_place`, `prep_z_gen` | 15 | `prep_do_gen`, `prep_place`, `prep_w_loc`, `prep_z_gen` |
...
| 40 | `leaf_work_a1` | — | 35 | `byc_adj`, `byc_present`, `inst_identity`, `miec_acc`, `miec_present`, `poss_nom`, `prep_w_loc`, `present_uje`, `to_jest`, `zgoda` |
| 41 | `leaf_ideas_a1` | — | 48 | `byc_adj`, `byc_present`, `comparative`, `miec_acc`, `miec_present`, `poss_nom`, `to_jest`, `zgoda` |
