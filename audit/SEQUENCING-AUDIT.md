...
**Nodes audited:** 44 · **errors:** 0 · **warns:** 0 · **missing_tags:** 0
...
| 38 | `a1_negation` | `negation` | 14 | `miec_acc`, `miec_present`, `negation` |
| 39 | `trunk_there_time_a1` | `existential_jest` | 0 | `byc_present`, `existential_jest`, `negation`, `social_chunk` |
| 40 | `leaf_health_a1` | — | 23 | `byc_adj`, `byc_present`, `miec_acc`, `miec_present`, `to_jest`, `zgoda` |
| 41 | `a1_inst_job` | `inst_identity` | 16 | `byc_present`, `inst_identity` |
| 42 | `leaf_work_a1` | — | 35 | `byc_adj`, `byc_present`, `inst_identity`, `miec_acc`, `miec_present`, `poss_nom`, `prep_w_loc`, `present_uje`, `to_jest`, `zgoda` |
| 43 | `leaf_ideas_a1` | — | 48 | `byc_adj`, `byc_present`, `comparative`, `miec_acc`, `miec_present`, `poss_nom`, `to_jest`, `zgoda` |
