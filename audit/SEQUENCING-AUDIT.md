...
**Nodes audited:** 43 · **errors:** 0 · **warns:** 0 · **missing_tags:** 0
...
| 8 | `trunk_adjectives_a1` | `byc_adj` | 23 | `byc_adj`, `byc_present`, `poss_nom`, `to_jest`, `zgoda` |
...
| 33 | `a1_motion` | `motion_chunk` | 4 | `motion_chunk`, `prep_do_gen`, `prep_place`, `prep_z_gen` |
| 34 | `leaf_city_a1` | — | 29 | `byc_adj`, `byc_present`, `miec_acc`, `miec_present`, `poss_nom`, `prep_do_gen`, `prep_place`, `prep_w_loc`, `prep_z_gen`, `present_am`, `to_jest`, `zgoda` |
| 35 | `leaf_body_a1` | — | 23 | `byc_adj`, `byc_present`, `poss_nom`, `to_jest`, `zgoda` |
| 36 | `leaf_time_cal_a1` | — | 48 | `byc_adj`, `byc_present`, `miec_acc`, `present_am`, `present_e_esz`, `present_uje`, `social_chunk`, `to_jest`, `zgoda` |
| 37 | `a1_negation` | `negation` | 14 | `miec_acc`, `miec_present`, `negation` |
| 38 | `trunk_there_time_a1` | `existential_jest` | 0 | `byc_present`, `existential_jest`, `negation`, `social_chunk` |
| 39 | `leaf_health_a1` | — | 23 | `byc_adj`, `byc_present`, `miec_acc`, `miec_present`, `to_jest`, `zgoda` |
| 40 | `a1_inst_job` | `inst_identity` | 16 | `byc_present`, `inst_identity` |
| 41 | `leaf_work_a1` | — | 35 | `byc_adj`, `byc_present`, `inst_identity`, `miec_acc`, `miec_present`, `poss_nom`, `prep_w_loc`, `present_uje`, `to_jest`, `zgoda` |
| 42 | `leaf_ideas_a1` | — | 48 | `byc_adj`, `byc_present`, `comparative`, `miec_acc`, `miec_present`, `poss_nom`, `to_jest`, `zgoda` |
